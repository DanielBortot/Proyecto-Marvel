    ...
    return (
        <div className="header">
            ...
            <div className="inisesion hed">
                {(descUsuario.Nombre && perfilUso.Nombre) ? <Link className='custom-button2 btn btn-secondary px-4 py-4' to={'/inicioSesion'} onClick={()=>delDatos()}>Logout</Link> : <Link className='custom-button2 btn btn-secondary px-4 py-4' to={'/inicioSesion'}>Iniciar Sesion</Link>}
